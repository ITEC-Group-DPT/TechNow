...
public class Laptop_Catalog extends Fragment {
        ...
        protected String doInBackground(ArrayList... arrayLists) {
            ...
            reff.addListenerForSingleValueEvent(new ValueEventListener() {
                ...
                public void onDataChange(@NonNull DataSnapshot snapshot) {
                    ...
                    productListViewAdapter = new ProductListViewAdapter(getContext(), R.layout.product_listview_layout, laptops);
                    laptop_lv.setAdapter(productListViewAdapter);
    ...
    public void sortPriceHighest() {
        Collections.sort(laptops, new Comparator<Product>() {
