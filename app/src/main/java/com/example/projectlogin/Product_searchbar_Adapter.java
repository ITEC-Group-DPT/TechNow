...
public class Product_searchbar_Adapter extends ArrayAdapter<Product> {
    private Context context;
    private int layoutID;
    private ArrayList<Product> Products;
    private NumberFormat format = new DecimalFormat("#,###");

    public Product_searchbar_Adapter(@NonNull Context context, int resource, @NonNull List<Product> objects) {
